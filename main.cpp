...
cout << endl << "*********** Military Base Camp ********************" << endl << endl;
    ...
    cout << "          COMPUTER GRAPHICS [A]           " << endl ;
    cout << "  Project Submission [ Spring 2022-2023 ]" << endl << endl;
    cout << "Submitted By : SHAHRIAZ POLOK,KAZI ISTIAK AHAMMED,MD. AHSANUL MOSTAKIN,SALMAN" << endl ;
